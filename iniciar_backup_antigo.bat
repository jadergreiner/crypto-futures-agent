...
REM ==============================================================================
REM VERIFICACAO AUTOMATICA: OPERACAO PARALELA
REM Se arquivo de autorizacao existir, ativar automaticamente
REM ==============================================================================

if exist "AUTHORIZATION_OPÇÃO_C_20FEV.txt" (
    echo [VERIFICACAO AUTOMATICA] Operacao detectada em background...
    echo.

    REM Mensagem simples sem caracteres especiais
    echo [INFORMACAO] Sistema pode estar efetuando operacoes paralelas
...
echo.
echo ===============================================
echo        OPERADOR - ESCOLHA UMA OPCAO
echo ===============================================
echo.
echo   1. Teste (Paper Trading - SEM RISCO, apenas validacao)
echo.
echo   2. OPERACAO PADRAO - INICIAR AGENTE LIVE COM TREINAMENTO
echo      (Opcao recomendada - usa configuracao ja decidida)
echo.
echo   --- Opcoes Avancadas ---
echo   3. Monitorar Posicoes Abertas
echo   4. Executar Backtest
echo   5. Treinar Modelo RL Manualmente
...
echo ===============================================
echo.
set /p OPCAO="Digite o numero da opcao desejada (1-9): "
...
:opcao2
echo INICIANDO AGENTE EM MODO LIVE OPERACIONAL
echo ==============================================================================
echo.
...
echo.
echo Configuracao OPERACIONAL (ja decidida pela reuniao):
echo   - Capital por posicao: U$ 1,00
echo   - Alavancagem: 10x
echo   - Stop Loss: Obrigatorio
echo   - Parcial 50%% + Take Profit final
echo   - Treinamento concorrente: A CADA 2 HORAS
echo   - Monitoramento: Continuo
echo.
echo Confirme 2 vezes que compreende os riscos:
echo.
set /p CONF1="[1/2] Os orders sao REAIS? Digite 'SIM': "
if /i not "!CONF1!"=="SIM" (
    echo Operacao cancelada.
    goto :final
)

set /p CONF2="[2/2] Voce eh o operador autorizado? Digite 'INICIO': "
if /i not "!CONF2!"=="INICIO" (
    echo Operacao cancelada.
    goto :final
)

echo.
echo Iniciando em modo LIVE OPERACIONAL...
echo.
echo Configuracao FIXA (decidida pela reuniao):
echo   - Modo: LIVE (capital REAL)
echo   - Intervalo de decisao: 300 segundos (5 minutos)
echo   - Intervalo de treinamento: 7200 segundos (2 HORAS)
echo   - Aprendizado concorrente: ATIVADO
echo.
echo Inicio: %date% %time%
echo Log: logs/agent.log
echo Posicoes sendo monitoradas: 20 abertas + novas oportunidades
echo.
echo Pressione Ctrl+C para PARAR SISTEMA COM SEGURANCA.
echo.

REM Executar com configuracao OPERACIONAL fixa
