...
# Limite de episodios para disparo de retreino (PADRONIZADO)
# Sincronizado com:
#   - continuous_learning_controller.py (trigger automático)
#   - continuous_learning_cycle.py (orquestrador)
        ...
        try:
            ...
            try:
                ...
                query_parts = [
                    ...
                    "  AND COALESCE(",
                    "    CASE",
                    "      WHEN TRIM(CAST(created_at AS TEXT), '0123456789') = ''",
                    "        THEN CASE",
                    "          WHEN CAST(created_at AS INTEGER) > 100000000000",
                    "            THEN CAST(created_at AS INTEGER)",
                    "          WHEN CAST(created_at AS INTEGER) > 0",
                    "            THEN CAST(created_at AS INTEGER) * 1000",
                    "          ELSE 0",
                    "        END",
