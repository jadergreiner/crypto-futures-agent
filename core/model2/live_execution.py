...
REASON_CODE_CATALOG: dict[str, str] = {
    ...
    "timeout": "ops.timeout",
    "transient_error": "ops.transient_error",
    "validation_error": "ops.validation_error",
    "permanent_error": "ops.permanent_error",
    "unknown_execution_error": "ops.unknown_execution_error",
...
REASON_CODE_SEVERITY: dict[str, str] = {
    ...
    "timeout": "HIGH",
    "transient_error": "HIGH",
    "validation_error": "HIGH",
    "permanent_error": "HIGH",
    "unknown_execution_error": "CRITICAL",
...
REASON_CODE_ACTION: dict[str, str] = {
    ...
    "transient_error": "aplicar_retry_controlado",
    "validation_error": "corrigir_payload_antes_de_reexecutar",
    "permanent_error": "bloquear_operacao",
    "unknown_execution_error": "bloquear_operacao",
