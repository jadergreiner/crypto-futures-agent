        ...
        try:
            ...
            compiled = {
                ...
                'metrics': {
                    ...
                    'vol_floor': metrics.get('vol_floor', 0),
                    'num_trades_evaluated': metrics.get('num_trades_evaluated', 0),
                    'metric_sanity_passed': metrics.get('metric_sanity_passed', False),
                    'sanity_issues': metrics.get('sanity_issues', []),
                },
                ...
                ) and metrics.get('metric_sanity_passed', False),
            }
        ...
        try:
            ...
            report = {
                ...
                'recommendations': [
                    ...
                    if metrics.get('metrics', {}).get('metric_sanity_passed', False)
                    else '⚠️ Review metric sanity before deployment',
                ],
            }
