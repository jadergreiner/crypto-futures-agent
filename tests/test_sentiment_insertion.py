...
def test_insert_sentiment_com_campos_completos():
...
def test_insert_sentiment_com_campos_ausentes():
...
def test_insert_sentiment_multiplos_simbolos():
...
def test_insert_sentiment_vazio():
