...
|---------------------------------|----------|--------|---------------------------------------|--------------------------------------------------|
| Integração de Conectividade     | Sprint 1 | TODO   | `data/`, `config/settings.py`        | [Ver critérios](CRITERIOS_DE_ACEITE_MVP.md#s1-1) |
| Risk Gate 1.0                   | Sprint 1 | TODO   | `risk/`, `config/settings.py`        | [Ver critérios](CRITERIOS_DE_ACEITE_MVP.md#s1-2) |
| Módulo de Execução              | Sprint 1 | TODO   | `execution/`                          | [Ver critérios](CRITERIOS_DE_ACEITE_MVP.md#s1-3) |
| Telemetria Básica               | Sprint 1 | TODO   | `logs/`, `main.py`                   | [Ver critérios](CRITERIOS_DE_ACEITE_MVP.md#s1-4) |
...
|----------------------------------|-------------|--------|--------|--------|
| Conectividade Binance REST/WS    | TODO        | 🟡     | TODO   | TODO   |
| Stop Loss Hardcoded (-3%)        | TODO        | 🟡     | TODO   | TODO   |
| Circuit Breaker engine           | TODO        | 🟡     | TODO   | TODO   |
| Orquestrador de ordens           | TODO        | 🟡     | TODO   | TODO   |
| Tratamento de erros API          | TODO        | 🟡     | TODO   | TODO   |
| Logs estruturados de trades      | TODO        | 🟡     | TODO   | TODO   |
